  ...
  cartItems: [
    {
      ...
      "id": 7,
      "price": 1000,
      "thumbnailUrl": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGasNqKInCpdzxEnVUrcjaBmB8pHq99H4U7U-vQaVhElWEIwiU",
  ...
  on(increment,(state:cartState,action)=>{
    let currentQuantity=action.item.quantity;
      ...
      return {
        ...
        cartItems:[...state.cartItems.filter((value)=>value.id!==action.item.id),incitem]
      };
  }),
